    ...
    <body>
        ...
        <div class="scrollableContent">
            ...
            <div class="contactcontainer">
                <div class="contactsubtitle">Contact Us</div>
                <div class="contactdescription">UMRF Ventures, Inc 4075 Park Avenue Memphis, TN 38111</div>
                <div class="contactdescription">Phone: (901) 678-4444</div>
                <div class="contactdescription">Email: info@umrfventures.com</div>
            </div>

            <div class="contactmapcontainer" style="background-image: url('assets/UMRFBuildingFront.png');">
            ...
            <div class="contactcontainer">
                <div class="contactsubtitle">Partners</div>
                <div class="contactdescription">If you are interested in partnering with UMRF Ventures and building a custom venture to support your company while establishing a talent pipeline, contact one of the email addresses below.</div>
                <div class="contactdescription">Pierre Landaiche, CEO</div>
                <div class="contactdescription">Email: pierre@umrfventures.com</div>
                <div class="contactdescription">JT (Jutta) Schneider, Director Project Management & Corporate Initiatives</div>
                <div class="contactdescription">Email: jtschneider@umrfventures.com</div>
            </div>
